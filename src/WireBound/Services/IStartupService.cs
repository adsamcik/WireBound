...
/// <summary>
/// Service for managing application startup registration with Windows.
/// Handles both packaged (MSIX) and non-packaged (portable) deployments.
/// </summary>
public interface IStartupService
{
    /// <summary>
    /// Gets whether the application is currently registered to start with Windows.
    /// </summary>
    ...
    /// <summary>
    /// Enables or disables startup with Windows and returns the resulting state.
...
{
    /// <summary>
    /// Startup is disabled by the user.
    /// </summary>
    Disabled,
    ...
    /// <summary>
    /// Startup was disabled by the user in Windows settings (Task Manager).
    /// </summary>
    DisabledByUser,

    /// <summary>
    /// Startup was disabled by group policy.
    /// </summary>
    DisabledByPolicy,
